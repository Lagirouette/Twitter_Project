...
import { CreateNewComment, CreateNewPost } from '@/api/ApiCalls'
import { RecupTokenBool } from '@/Token/RecupToken'
import { useRouter } from 'next/navigation'
import React, { SyntheticEvent, useState } from 'react'

export default function CommentTextArea({postId}:{postId:number}){
    ...
    <>
        <form action="" onSubmit={submit}>
            ...
            <div className='flex w-full pt-2'>
                ...
                <button type='submit' className='ms-auto bg-sky-500 hover:bg-sky-800 rounded-full py-2 px-3 place-self-end font-bold'>Send</button>
