        ...
        <div className="flex justify-between pr-20">
            <div className="flex">
                <button onClick={() => {router.push("/tweet/"+postId)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 hover:fill-white active:text-gray-900">
            ...
            <svg className="mt-1 size-5 hover:text-green-500 active:text-green-900"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="1.5"  strokeLinecap="round"  strokeLinejoin="round">  
            ...
            <div className="flex">
                <button>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 hover:fill-pink-500 hover:border-pink-500 hover:text-pink-500 active:text-pink-950">
                ...
                <p className="pl-1 pb-1">{data}</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="mt-1 size-5 hover:text-blue-700 active:text-blue-900">
