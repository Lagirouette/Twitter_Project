...
const Sidebar = () => {
  return (
    <>
        <Link href="/feed"><svg className="h-10 w-10 text-sky-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
        ...
        <div className='py-7'>
            <div className='menu py-4'>
                <a className='hover:text-sky-500 flex' href="">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 h-8 w-8 flex-none">
            ...
            <div className='menu py-4'>
                <Link className='hover:text-sky-500 flex' href="profilePage/2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 h-8 w-8 flex-none">
