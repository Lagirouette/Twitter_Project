...
export default function LeftSideBar() {
    return (
        <>
            <div className="bg-zinc-800 rounded-full py-2 flex">
                ...
                <a href="#" className="search_icon">
                    ...
                    <input className="search_input bg-zinc-800 ml-2" type="text" placeholder="Search Twitter" />
            </div>

            <div className="bg-zinc-800 rounded-xl mt-2 flex flex-col divide-y divide-gray-700">
                ...
                <div className="p-2 hover:bg-gray-500">
                    <p className="text-gray-700 text-sm">Trending worldwide</p>
                    <h1 className="font-bold">#BreakingNews</h1>
                    <div className="flex py-1">
                        <div className="border-gray-700 border border-solid rounded-l-lg w-3/4">
                            <p className="text-gray-700 text-sm px-1 pt-2">Space</p>
                            <p className="text-sm px-1 pb-2">Lunar photography improves the discovery of the moon</p>
                        </div>
                        <div className="ms-auto border-gray-700 border border-solid rounded-r-lg w-1/4">
                            <Image src={Moon} alt="Moon image" className="w-full h-full rounded-r-lg"/>
                        </div>
                    </div>
                    <p className="text-gray-700 text-sm">10,094 people are Tweeting about this</p>
                </div>
                <div className="p-2 hover:bg-gray-500">
                    <p className="text-gray-700 text-sm">Trending worldwide</p>
                    <h1 className="font-bold">#WorldNews</h1>
                    <p className="text-gray-700 text-base">125K Tweets</p>
                    <p className="text-gray-700 text-sm">5,094 people are Tweeting about this</p>
                </div>
                <div className="p-2 hover:bg-gray-500">
                    <p className="text-gray-700 text-sm">Trending worldwide</p>
                    <h1 className="font-bold">#BreakingNews</h1>
                    <div className="flex py-1">
                        <div className="border-gray-700 border border-solid rounded-l-lg w-3/4">
                            <p className="text-gray-700 text-sm px-1 pt-2">Animals</p>
                    ...
                    <p className="text-gray-700 text-sm">2,757 people are Tweeting about this</p>
                </div>
                <div className="p-2 hover:bg-gray-500">
                    <p className="text-gray-700 text-sm">Trending worldwide</p>
                    <h1 className="font-bold">#GreatestOfAllTime</h1>
                    <p className="text-gray-700 text-base">100K Tweets</p>
                    <p className="text-gray-700 text-sm">4,123 people are Tweeting about this</p>
                </div>
                <div className="p-2">
